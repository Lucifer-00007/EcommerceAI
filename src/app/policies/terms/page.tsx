            ...
            <Reveal delay={0.1}>
              <Card className="border shadow-sm">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl font-bold">Agreement to Terms</CardTitle>
                </CardHeader>
            ...
            <Reveal delay={0.2}>
              <Card className="border shadow-sm">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl font-bold">Intellectual Property Rights</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 text-muted-foreground leading-relaxed px-6 sm:px-8 pb-8">
                  <p>
            ...
            <Reveal delay={0.3}>
              <Card className="border shadow-sm">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl font-bold">User Representations</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 text-muted-foreground leading-relaxed px-6 sm:px-8 pb-8">
                  <p>
